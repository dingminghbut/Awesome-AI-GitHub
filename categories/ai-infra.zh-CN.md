...
| 4 | [Ascotbe/Medusa](https://github.com/Ascotbe/Medusa) | 电商 AI 基础设施 | 电商技能, 开源许可, 有文档 | 2,236 | +0 | +0 | Python | :cat2:Medusa是一个红队武器库平台，目前包括XSS平台、协同平台、CVE监控、免杀生成、DNSLOG、钓鱼邮件、文件获取等功能，持续开发中 |
...
| 6 | [store-craft/storecraft](https://github.com/store-craft/storecraft) | 电商 AI 基础设施 | 电商技能, 有文档, 有演示/应用 | 826 | +0 | +0 | JavaScript | ⭐ Rapidly build AI-powered, Headless e-commerce backends with TypeScript |
