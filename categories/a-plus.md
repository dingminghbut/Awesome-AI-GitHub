...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [AJbeckliy/detail-flow](https://github.com/AJbeckliy/detail-flow) | A+ Content Generation | Commerce skill | 111 | +2 | +10 | Unknown | A reusable Codex skill for planning, generating, auditing, and delivering ecommerce product detail pages. |
