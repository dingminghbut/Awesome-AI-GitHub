...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [emb-ai/RoboBenchMart](https://github.com/emb-ai/RoboBenchMart) | 零售机器人与履约自动化 | 近期活跃, 电商技能, 开源许可, 有文档 | 72 | +1 | +2 | Python | RoboBenchMart: Benchmarking Robots in Retail Environment |
