...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [emb-ai/RoboBenchMart](https://github.com/emb-ai/RoboBenchMart) | Retail Robotics & Fulfillment | Recently active, Commerce skill, Open license, Docs available | 74 | +0 | +2 | Python | RoboBenchMart: Benchmarking Robots in Retail Environment |
