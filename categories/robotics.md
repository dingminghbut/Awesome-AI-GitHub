...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [emb-ai/RoboBenchMart](https://github.com/emb-ai/RoboBenchMart) | Retail Robotics & Fulfillment | Commerce skill, Open license, Docs available, Research signal | 74 | +0 | +1 | Python | RoboBenchMart: Benchmarking Robots in Retail Environment |
