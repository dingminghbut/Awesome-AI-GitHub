...
| 2 | [contentful/apps](https://github.com/contentful/apps) | Commerce AI Infrastructure | Recently active, Commerce skill, Docs available, Good starting point | 165 | +1 | +1 | TypeScript | Apps on the Contentful Marketplace and resources to build them |
| 3 | [store-craft/storecraft](https://github.com/store-craft/storecraft) | Commerce AI Infrastructure | Commerce skill, Docs available, Demo or app | 824 | +1 | +1 | JavaScript | ⭐ Rapidly build AI-powered, Headless e-commerce backends with TypeScript |
